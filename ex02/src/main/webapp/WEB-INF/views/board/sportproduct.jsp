 		 ...
 		 <div class="collapse navbar-collapse bg-white" id="navbarSupportedContent">
   		   ...
   		   <li class="nav-item dropdown">
     		   ...
     		   <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="mobiledropdownmenu">
        		  <a class="dropdown-item" href="#">스니커즈</a>
        		  <a class="dropdown-item" href="#">캔버스화</a>
        		  <a class="dropdown-item" href="#">슬립온</a>
       		   <div class="dropdown-divider"></div>
      		   <a class="dropdown-item" href="#">키즈</a>
      		  </div>
     		</li>
     		 <li class="nav-item dropdown">
      		  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
     		   ...
     		   <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="mobiledropdownmenu">
        		  <a class="dropdown-item" href="#">런닝화</a>
        		  <a class="dropdown-item" href="#">골프화</a>
        		  <a class="dropdown-item" href="#">등산화</a>
       		   <div class="dropdown-divider"></div>
      		   <a class="dropdown-item" href="#">키즈</a>
      		  </div>
     		</li>
     		 <li class="nav-item dropdown">
     		   ...
     		   <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="mobiledropdownmenu">
        		  ...
        		  <a class="dropdown-item" href="#">힐</a>
      		  </div>
     		</li>
     		<li class="nav-item">
     		   <a class="nav-link" href="/board/event" id="navbarDropdown">샌들</a>
     		    <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="mobiledropdownmenu">
        		  <a class="dropdown-item" href="#">성인</a>
        		  <a class="dropdown-item" href="#">키즈</a>
      		  </div>
    		  </li>
     		 <li class="nav-item">
						...
						<div class="card" id="productcard">
							...
							<img class="card-img-top" src='https://d3fjc4x2ovyjvz.cloudfront.net${board.attachments}?w=200&h=200&q=100' alt="Card image cap"></a>
								 <div class="card-body">
    								 ...
    								 <p class="card-text" id="product_price_text">${board.price }원</p>
